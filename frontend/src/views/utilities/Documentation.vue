    ...
    <div class="col-12">
      <div class="card docs">
        ...
        <p>
          ...
          <i>http://localhost:5173/</i> to view the application. That is it, you may now start with
        ...
        <h5>Structure</h5>
        <p>
          Sakai consists of a couple folders, demos and layout have been separated so that you can
        ...
        <ul class="line-height-3">
          ...
          <li>
            <span class="text-primary font-medium">public/layout</span>: Assets used in layout
          </li>
          <li>
            <span class="text-primary font-medium">src/assets/demo</span>: Styles used in demos
          </li>
          <li>
        ...
        <p>
          ...
          <span class="text-primary font-medium">src/layout/AppMenu.vue</span> file.
        </p>
        ...
        <p>
          Sakai theming is based on the PrimeVue theme being used. Default theme is
        ...
        <p>
          ...
          <b>_variables.scss</b> file under src/layout folder. Saving the changes will be reflected
        ...
        <CodeHighlight>
          ...
          <br />
          $transitionDuration:.2s; /* transition duration of layout elements e.g. sidebar, overlay
          menus */
        </CodeHighlight>
      </div>
    </div>
