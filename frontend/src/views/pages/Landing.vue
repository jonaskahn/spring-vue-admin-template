    ...
    <div class="surface-0 flex justify-content-center">
        <div id="home" class="landing-wrapper overflow-hidden">
            <div class="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static mb-3">
                <a class="flex align-items-center" href="#"> <img :src="logoUrl" alt="Sakai Logo" class="mr-0 lg:mr-2" height="50" /><span class="text-900 font-medium text-2xl line-height-3 mr-8">SAKAI</span> </a>
                ...
                <div class="align-items-center surface-0 flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 px-6 lg:px-0 z-2" style="top: 120px">
                    ...
                    <div class="flex justify-content-between lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 mt-3 lg:mt-0">
                        <Button class="p-button-text p-button-rounded border-none font-light line-height-2 text-blue-500" label="Login"></Button>
                        <Button class="p-button-rounded border-none ml-5 font-light text-white line-height-2 bg-blue-500" label="Register"></Button>
                    </div>
                </div>
            </div>
            ...
            >
                <div class="mx-4 md:mx-8 mt-0 md:mt-4">
                    ...
                    <Button class="p-button-rounded text-xl border-none mt-5 bg-blue-500 font-normal text-white line-height-3 px-3" label="Get Started"></Button>
                </div>
                ...
                <div class="grid justify-content-between mt-8 md:mt-0">
                    <div class="col-12 lg:col-4 p-0 md:p-3">
                        <div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
                            ...
                            <div class="my-5 text-center">
                                ...
                                <Button class="block mx-auto mt-4 p-button-rounded border-none ml-3 font-light line-height-2 bg-blue-500 text-white" label="Get Started"></Button>
                            </div>
                    ...
                    <div class="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
                        <div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
                            ...
                            <div class="my-5 text-center">
                                ...
                                <span class="text-600">per month</span>
                                <Button class="block mx-auto mt-4 p-button-rounded border-none ml-3 font-light line-height-2 bg-blue-500 text-white" label="Try Free"></Button>
                            </div>
                            <Divider class="w-full bg-surface-200"></Divider>
                            <ul class="my-5 list-none p-0 flex text-900 flex-column">
                                <li class="py-2">
                    ...
                    <div class="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
                        <div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
                            ...
                            <img alt="enterprise" class="w-10 h-10 mx-auto" src="/demo/images/landing/enterprise.svg" />
                            <div class="my-5 text-center">
                                <span class="text-5xl font-bold mr-2 text-900">$999</span>
                                <span class="text-600">per month</span>
                                <Button class="block mx-auto mt-4 p-button-rounded border-none ml-3 font-light line-height-2 bg-blue-500 text-white" label="Get a Quote"></Button>
                            </div>
                            <Divider class="w-full bg-surface-200"></Divider>
                            <ul class="my-5 list-none p-0 flex text-900 flex-column">
                                <li class="py-2">
                    ...
                    <div class="col-12 md:col-10 lg:col-7">
                        <div class="grid text-center md:text-left">
                            ...
                            <div class="col-12 md:col-3 mt-4 md:mt-0">
                                ...
                                <a class="line-height-3 text-xl block cursor-pointer mb-2 text-700">Events<img class="ml-2" src="/demo/images/landing/new-badge.svg" /></a>
