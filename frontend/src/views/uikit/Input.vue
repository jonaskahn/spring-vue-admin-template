    ...
    <div class="grid p-fluid">
        <div class="col-12 md:col-6">
            <div class="card">
                ...
                <h5>AutoComplete</h5>
                <AutoComplete id="dd" v-model="selectedAutoValue" :dropdown="true" :multiple="true" :suggestions="autoFilteredValue" field="name" placeholder="Search" @complete="searchCountry($event)" />
