    ...
    <div class="grid">
                ...
                >
                    <template #header>
                        <div class="flex justify-content-between flex-column sm:flex-row">
                            <Button class="p-button-outlined mb-2" icon="pi pi-filter-slash" label="Clear" type="button" @click="clearFilter1()" />
                    ...
                    <Column filterField="country.name" header="Country" style="min-width: 12rem">
                        <template #body="{ data }">
                            <img :alt="data.country.name" :class="'flag flag-' + data.country.code" src="/demo/images/flag/flag_placeholder.png" width="30" />
                            <span class="image-text" style="margin-left: 0.5em; vertical-align: middle">{{ data.country.name }}</span>
                        </template>
                        <template #filter="{ filterModel }">
                            <InputText v-model="filterModel.value" class="p-column-filter" placeholder="Search by country" type="text" />
                        </template>
                        <template #filterclear="{ filterCallback }">
                            <Button class="p-button-secondary" icon="pi pi-times" type="button" @click="filterCallback()"></Button>
                        </template>
                        <template #filterapply="{ filterCallback }">
                            <Button class="p-button-success" icon="pi pi-check" type="button" @click="filterCallback()"></Button>
                        </template>
                    </Column>
                    <Column :filterMenuStyle="{ width: '14rem' }" :showFilterMatchModes="false" filterField="representative" header="Agent" style="min-width: 14rem">
                        <template #body="{ data }">
                            <img :alt="data.representative.name" :src="contextPath + 'demo/images/avatar/' + data.representative.image" style="vertical-align: middle" width="32" />
                            <span class="image-text" style="margin-left: 0.5em; vertical-align: middle">{{ data.representative.name }}</span>
                        </template>
                        <template #filter="{ filterModel }">
                            <div class="mb-3 text-bold">Agent Picker</div>
                            <MultiSelect v-model="filterModel.value" :options="representatives" class="p-column-filter" optionLabel="name" placeholder="Any">
                                <template #option="slotProps">
                                    <div class="p-multiselect-representative-option">
                                        <img :alt="slotProps.option.name" :src="contextPath + 'demo/images/avatar/' + slotProps.option.image" style="vertical-align: middle" width="32" />
                                        <span class="image-text" style="margin-left: 0.5em; vertical-align: middle">{{ slotProps.option.name }}</span>
                                    </div>
                                </template>
                            </MultiSelect>
                        </template>
                    ...
                    <Column bodyClass="text-center" dataType="boolean" field="verified" header="Verified" style="min-width: 8rem">
                        <template #body="{ data }">
                            <i :class="{ 'text-green-500 pi-check-circle': data.verified, 'text-pink-500 pi-times-circle': !data.verified }" class="pi"></i>
                        </template>
                        <template #filter="{ filterModel }">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <ToggleButton v-model="idFrozen" offIcon="pi pi-lock-open" offLabel="Freeze Id" onIcon="pi pi-lock" onLabel="Unfreeze Id" style="width: 10rem" />

                <DataTable :loading="loading2" :scrollable="true" :value="customer2" class="mt-3" scrollDirection="both" scrollHeight="400px">
                    ...
                    <Column :style="{ width: '200px' }" field="country.name" header="Country">
                        <template #body="{ data }">
                            <img :class="'flag flag-' + data.country.code" src="/demo/images/flag/flag_placeholder.png" width="30" />
                            <span class="image-text" style="margin-left: 0.5em; vertical-align: middle">{{ data.country.name }}</span>
                        </template>
                    </Column>
                    ...
                    <Column :style="{ width: '150px' }" alignFrozen="right" field="balance" frozen header="Balance">
                        <template #body="{ data }">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <DataTable v-model:expandedRows="expandedRows" :value="products" dataKey="id" responsiveLayout="scroll">
                    ...
                    <Column header="Image">
                        <template #body="slotProps">
                            <img :alt="slotProps.data.image" :src="contextPath + 'demo/images/product/' + slotProps.data.image" class="shadow-2" width="100" />
                        </template>
                    </Column>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <DataTable :sortOrder="1" :value="customer3" groupRowsBy="representative.name" rowGroupMode="subheader" scrollHeight="400px" scrollable sortField="representative.name" sortMode="single">
                    <Column field="representative.name" header="Representative"></Column>
                    <Column field="name" header="Name" style="min-width: 200px"></Column>
                    <Column field="country" header="Country" style="min-width: 200px">
                        <template #body="slotProps">
                            <img :class="'flag flag-' + slotProps.data.country.code" src="/demo/images/flag/flag_placeholder.png" width="30" />
                    ...
                    <template #groupheader="slotProps">
                        <img :alt="slotProps.data.representative.name" :src="contextPath + 'demo/images/avatar/' + slotProps.data.representative.image" style="vertical-align: middle" width="32" />
