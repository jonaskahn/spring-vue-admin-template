    ...
    <div class="grid">
        ...
        <div class="col-12 lg:col-6">
            <div class="card">
                ...
                <Button badge="8" badgeClass="p-badge-danger" class="p-button-warning" icon="pi pi-users" label="Messages"></Button>
            ...
            <div class="card">
                ...
                <AvatarGroup class="mb-3">
                    <Avatar :image="contextPath + 'demo/images/avatar/amyelsner.png'" shape="circle" size="large"></Avatar>
                    <Avatar :image="contextPath + 'demo/images/avatar/asiyajavayant.png'" shape="circle" size="large"></Avatar>
                    <Avatar :image="contextPath + 'demo/images/avatar/onyamalimba.png'" shape="circle" size="large"></Avatar>
                    <Avatar :image="contextPath + 'demo/images/avatar/ionibowcher.png'" shape="circle" size="large"></Avatar>
                    <Avatar :image="contextPath + 'demo/images/avatar/xuxuefeng.png'" shape="circle" size="large"></Avatar>
        ...
        <div class="col-12 lg:col-6">
            ...
            <div class="card">
                ...
                <h5>Image</h5>
                <div class="flex align-items-center flex-column sm:flex-row">
                    <Chip :image="contextPath + 'demo/images/avatar/amyelsner.png'" class="mr-2 mb-2" label="Amy Elsner"></Chip>
                    <Chip :image="contextPath + 'demo/images/avatar/asiyajavayant.png'" class="mr-2 mb-2" label="Asiya Javayant"></Chip>
                    <Chip :image="contextPath + 'demo/images/avatar/onyamalimba.png'" class="mr-2 mb-2" label="Onyama Limba"></Chip>
                </div>
            </div>
