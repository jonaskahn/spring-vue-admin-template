...
<template>
    <div class="grid">
        <div class="col-12 lg:col-6">
            ...
            <div class="card p-fluid">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <div>
                        <Button class="p-button-success" label="DataTable" type="button" @click="toggleDataTable" />
                        <OverlayPanel id="overlay_panel" ref="op2" :showCloseIcon="true" appendTo="body" style="width: 450px">
                            <DataTable v-model:selection="selectedProduct" :paginator="true" :rows="5" :value="products" responsiveLayout="scroll" selectionMode="single" @row-select="onProductSelect">
                                ...
                                <Column header="Image" headerStyle="min-width:5rem;">
                                    <template #body="slotProps">
                                        <img :alt="slotProps.data.image" :src="contextPath + 'demo/images/product/' + slotProps.data.image" class="shadow-2" width="50" />
                                    </template>
                                </Column>
        ...
        <div class="col-12 lg:col-6">
            <div class="card p-fluid">
                <h5>Confirmation</h5>
                <Button class="p-button-danger" icon="pi pi-trash" label="Delete" style="width: auto" @click="openConfirmation" />
                <Dialog v-model:visible="displayConfirmation" :modal="true" :style="{ width: '350px' }" header="Confirmation">
                    ...
                    <template #footer>
                        <Button class="p-button-text" icon="pi pi-times" label="No" @click="closeConfirmation" />
                        <Button autofocus class="p-button-text" icon="pi pi-check" label="Yes" @click="closeConfirmation" />
                    </template>
                </Dialog>
            </div>
            <div class="card">
                ...
                <Button class="p-button-warning" icon="pi pi-arrow-right" style="margin-right: 0.25em" @click="visibleLeft = true" />
                <Button class="p-button-warning" icon="pi pi-arrow-left" style="margin-right: 0.25em" @click="visibleRight = true" />
                <Button class="p-button-warning" icon="pi pi-arrow-down" style="margin-right: 0.25em" @click="visibleTop = true" />
                <Button class="p-button-warning" icon="pi pi-arrow-up" style="margin-right: 0.25em" @click="visibleBottom = true" />
