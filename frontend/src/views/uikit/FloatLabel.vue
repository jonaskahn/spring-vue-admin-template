...
<template>
    <div class="card">
        ...
        <div class="grid p-fluid mt-3">
            ...
            <div class="field col-12 md:col-4">
                <span class="p-float-label">
                    <MultiSelect id="multiselect" v-model="value9" :filter="false" :options="cities" optionLabel="name"></MultiSelect>
                    <label for="multiselect">MultiSelect</label>
                </span>
            </div>
            <div class="field col-12 md:col-4">
                <span class="p-float-label">
                    <Textarea v-model="value10" cols="30" inputId="textarea" rows="3"></Textarea>
